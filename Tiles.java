...
public class Tiles extends JPanel {
    private int WIDTH; // final and = 75; was removed
    private int HEIGHT; // final and = 75; was removed
    ...
    protected void paintComponent(Graphics g) { // Paints tiles. If piece is
        ...
        if (piece != null) {
            ...
            int padding = currentWidth / 8;
            int pieceSize = currentWidth - (padding * 2);
            g2.fillOval(padding, padding, pieceSize, pieceSize); // Creates "checker" look, // "5, 5, 65, 65" was changed
        }
